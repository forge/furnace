...
public class AddonState
{
   ...
   public AddonState(Set<AddonDependency> dependencies, AddonRepository repository, AddonModuleLoader loader,
            Module module)
   {
      ...
      Assert.notNull(loader, "Addon loader must not be null.");
