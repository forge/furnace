...
public class ClassLoaderAdapterResultProxyTest
{
   ...
   public static ForgeArchive getDeployment()
   {
      ForgeArchive archive = ShrinkWrap
               ...
               .addClasses(BasicInterface.class, AbstractClass.class, Implementation.class, InstanceFactory.class)
   ...
   public void testSharedImplementationTypeIncludedInProxy() throws Exception
   {
      ...
      Class<?> foreignType = dep1Loader.loadClass(InstanceFactory.class.getName());
      try
      {
