...
public class StrictModeEnabledByDefaultTest
{
   /*
   ...
   public void testDependenciesAreCorrectlyDeployedAndAssigned()
   {
      ...
      Assert.assertSame(AddonCompatibilityStrategies.STRICT, furnace.getAddonCompatibilityStrategy());
      ...
      Assert.assertEquals(AddonStatus.NEW, LocalServices.getFurnace(getClass().getClassLoader()).getAddonRegistry()
               .getAddon(AddonId.from(INCOMPATIBLE, INCOMPATIBLE_VERSION)).getStatus());
